export const AppointmentCTA = () => {
  return (
    <section className="container mx-auto px-4 max-w-[1200px]  pb-20  lg:pb-32">
     ...
     data-aos-duration="800" className="bg-in-cyan-light relative flex flex-col items-center px-6 py-16 text-center text-in-blue rounded-2xl gap-4 max-w-[1200px] mx-auto">
            ...
            <a className="flex justify-center bg-white gap-2 py-3 px-6 shadow-2xl rounded-4xl animate-[var(--animate-heartbeat)]" href="https://api.whatsapp.com/send/?phone=51957016010&text=Hola+%2AInsalud%2A.+Necesito+m%C3%A1s+informaci%C3%B3n+sobre+NOSOTROS+https%3A%2F%2Finsalud.pe%2Fnosotros&type=phone_number&app_absent=0" target="_blank">
                <img src="icons/wspCTA.svg" alt="logo whatsapp" />
                <p className="text-in-cyan-text font-medium">Agenda tu cita ahora</p>
            </a>

            {/* Iconos */}
            <img width={10} height={10} className="absolute w-14 md:w-28 left-0 top-2 md:-top-12 animate-[var(--animate-pulse)]" src="icons/plus-cyan.png" alt="plus icon" />
            <img width={10} height={10} className="absolute w-14 md:w-22 right-4 -bottom-2 animate-[var(--animate-pulse)]" src="icons/plus-cyan.png" alt="plus icon" />
            <img width={10} height={10} className="absolute hidden xl:block md:w-10 left-0 lg:-left-8 top-1/2 -translate-y-1/2 animate-[var(--animate-pulse)]" src="icons/plus-cyan.png" alt="plus icon" />
            <img width={10} height={10} className="absolute w-10 left-1/6  -bottom-6  animate-[var(--animate-pulse)]" src="icons/plus-cyan.png" alt="plus icon" />
            <img width={10} height={10} className="absolute w-6 left-5/6  -top-4  animate-[var(--animate-pulse)]" src="icons/plus-cyan.png" alt="plus icon" />
            <img width={10} height={10} className="absolute hidden xl:block w-10   -right-8 animate-[var(--animate-pulse)]" src="icons/plus-cyan.png" alt="plus icon" />
        </div>
    </section>
  )
}
