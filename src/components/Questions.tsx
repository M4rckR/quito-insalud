...
export const Questions = () => {
  ...
  return (
    <section id="preguntas" className="container mx-auto px-4 max-w-[1440px] py-6">
      <h2 className="text-center text-in-cyan-text text-2xl md:text-3xl lg:text-4xl font-medium mb-12">
        Preguntas Frecuentes
      </h2>

      <div className='flex flex-col md:flex-row gap-4 rounded-lg lg:px-16'>
